...
public class CreditCard extends Credit {
    ...
    public Credit create(Bank bank, Client client, double sum, int creditTerm) {
        if (sum <= 30000 && sum >=10000 && creditTerm <= 6){
            return new Credit(bank,client.getMobilePhone(),TypeOfCredit.CREDITCARD.type + "_1",  sum,41.9,creditTerm);
        }else if (sum <= 30000 && creditTerm > 6){
            return new Credit(bank,client.getMobilePhone(),TypeOfCredit.CREDITCARD.type + "_2",  sum,35.9,creditTerm);
        }else if (sum > 30000 && sum <= 500000 && creditTerm <= 6){
            return new Credit(bank,client.getMobilePhone(),TypeOfCredit.CREDITCARD.type + "_3",  sum,40.9,creditTerm);
        }else if (sum > 30000 && sum <= 500000 && creditTerm > 6){
            return new Credit(bank,client.getMobilePhone(),TypeOfCredit.CREDITCARD.type + "_4",  sum,37.9,creditTerm);
        }else if (sum > 50000 && sum <= 100000 && creditTerm <= 6 ){
            return new Credit(bank,client.getMobilePhone(),TypeOfCredit.CREDITCARD.type + "_5",  sum,35.9,creditTerm);
        }else if (sum > 50000 && sum <= 100000 && creditTerm > 6 && creditTerm<=12 ){
            return new Credit(bank,client.getMobilePhone(),TypeOfCredit.CREDITCARD.type + "_6",  sum,33.9,creditTerm);
        }else if (sum > 50000 && sum <= 100000 && creditTerm > 12 && creditTerm <=24 ){
            return new Credit(bank,client.getMobilePhone(),TypeOfCredit.CREDITCARD.type + "_7",  sum,30.9,creditTerm);
        }else if (sum > 100000 && sum <= 150000 && creditTerm <= 6  ){
            return new Credit(bank,client.getMobilePhone(),TypeOfCredit.CREDITCARD.type + "_8",  sum,31.9,creditTerm);
        }else if (sum > 100000 && sum <= 150000 && creditTerm > 6 && creditTerm<=12 ){
            return new Credit(bank,client.getMobilePhone(),TypeOfCredit.CREDITCARD.type + "_9",  sum,27.9,creditTerm);
        }else if (sum > 100000 && sum <= 150000 && creditTerm > 12 && creditTerm<=24 ){
            return new Credit(bank,client.getMobilePhone(),TypeOfCredit.CREDITCARD.type + "_10",  sum,25.9,creditTerm);
        }else {
